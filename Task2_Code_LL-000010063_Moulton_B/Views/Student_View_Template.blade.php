        ...
        <header>
            <nav class="navbar navbar-expand-sm navbar-light">
                <div class="container-fluid">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="Student_Dashboard.php" style="margin-left: 5vw;">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="Student_Courses.php" style="margin-left: 10vw;">My Courses</a>
                        </li>
                    </ul>
                    <a class="navbar-brand ms-auto" style="color: #565656;">GibJohn Tutorials</a>
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="Student_Preferences.php">Preferences</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" style="margin-right: 5vw; margin-left: 10vw;">Search</a>
                        </li>
                    </ul>
                </div>
            </nav>
